  ...
  bindEvent(){
    return {
      ...
      clickNextBtn :(object)=>{
        ...
        let nextCurrentDayIndex = this.props.currentDayIndex === planList.length-1 ? this.props.currentDayIndex : this.props.currentDayIndex+1;
          ...
          <span className="inner-searchCity">
            {
              ((currentDayIndex,type,isModifyCity)=>{
                ...
                if(currentDayIndex === 0 && (type === 0 || type === 1)){
                  //包车的第一天 不能修改
                  return (
