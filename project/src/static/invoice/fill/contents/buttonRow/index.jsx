...
class ButtonRow extends Component {
	...
	_getInvoiceInfo(props) {
		...
		_extend(this.data, {
			...
			// 'billAmount': this.data.invoiceInfo.billAmount, // 发票金额
			// 'orderNoList': this.data.invoiceInfo.orderNoList, // 订单号集R191151716919,J190108271520
	...
	_checkValid() {
		...
		if(!data.billAmount || !data.orderNoList || !data.orderNoList.length) {
			// 上一页传递参数错误
			window.history.back();
		}
	...
	render() {
		...
		return (
			<div className="button-row">
				<Button loading={this.state.sending} {...this.attr} onClick={this._submit.bind(this)}>确定</Button>
