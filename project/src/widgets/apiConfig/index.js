...
const MODIFYHOST = ((domain)=>{
  ...
  if(isDemo){
    return "https://www-dev.yundijie.com/"
    //白费：妈的不能跨域
...
module.exports = {
  ...
  'wxPay': 'https://api7-dev.huangbaoche.com/gateway/v1.0/web/wchat/oauthUrl',
  'alipay': MODIFYHOST+'trade/v1.0/c/pay/getwappayurl',
  'toPay': 'https://op-dev.huangbaoche.com/app/index.html', // 支付
  'cdnHost' : 'https://m-dev.huangbaoche.com/',
  "wxAuth": "https://op-test.huangbaoche.com/app/auth.html",
  "wxAppId": "wx1354271c597184ee",
  "getWxData" : "https://api7-dev.huangbaoche.com//marketing/v1.0/e/openapi/shares/conf", // 获取微信配置
  "captcha": "https://api7-dev.huangbaoche.com//file/v1.0/captcha",
  'storagePrefix': 'dev_ydj_', // storage前缀
  ...
  "storageKey": {
    'hotel_list_date': 'dev_ydj_list-date',
    'hotel_detail_data': 'dev_ydj_detail-data',
    'hotel_app_info': 'dev_ydj_app-info'
  },
  ...
  'ossToken': 'https://api7-dev.huangbaoche.com/passport/v1.0/ossToken', // 阿里云上传，获取oss token
